...
| `VEHICLE_PET_PROGRESS_SOURCE_V2` | proposed | no | implementation | contracts | `progress-source-registration`, `post-v1-external-progress-sources`, `token-usage-consumption-boundary` | none |
