...
export const zh = {
  ...
  'menu.title': '成长伙伴设置',
  'menu.character': '角色',
  'menu.character.vehicle': '车',
  'menu.character.companion': '伙伴',
  'menu.size': '大小',
  'menu.size.small': '小',
  'menu.size.large': '大',
  'menu.reducedMotion': '减少动效',
  'menu.reducedMotion.system': '跟随系统',
  'menu.reducedMotion.on': '开',
  'menu.reducedMotion.off': '关',
  'menu.collapse': '收起挂件',
...
export const en: Record<VehiclePetLocaleKey, string> = {
  ...
  'menu.character.vehicle': 'Vehicle',
  'menu.character.companion': 'Companion',
  'menu.size': 'Size',
