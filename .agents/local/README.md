...
UPSTREAM_ADOPTED_RELEASE = agent-development-governance v1.1.0 (source commit 0595e7e8a5f5bcd45660ca19fdabe932637af2ec; annotated tag v1.1.0)
LOCAL_ADOPTION_MAY_BECOME_ACCEPTED = YES
LOCAL_ADOPTION_LIFECYCLE = per .agents/governance.lock.json (v1.1.0 adoption candidate; the prior v1.0.3 adoption remains accepted history)
...
ARCHITECTURE_AND_INVARIANT_AUTHORITY = docs/specs/CONFIGURABLE_PET_ENGINE_V4.md and docs/specs/DSH_PET_OVERLAY_ADAPTER_V8.md (accepted, implementation authority)
CURRENT_PRODUCT_IMPLEMENTATION = PRESENT (web app and DSH bundle plugin)
CURRENT_GOVERNING_PRODUCT_SPECS = VEHICLE_PET_PRODUCT_DIRECTION_V1, CONFIGURABLE_PET_ENGINE_V4, DSH_PET_OVERLAY_ADAPTER_V8, VEHICLE_PET_PROGRESS_SOURCE_V2, DSH_USAGE_PROGRESS_SOURCE_V2, VEHICLE_PET_DEVELOPMENT_GOVERNANCE_ADOPTION_V2
